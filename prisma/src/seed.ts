...
async function seedCourse() {
  ...
  /* --------------------------------------------------------------------------
     ДРУГИЙ КУРС «ШІ для відкритих даних» — поки лише картка.

     Свідомо БЕЗ розділів і модулів: курс анонсовано, але його структура ще не
     вирішена, а вигадані заглушки в CMS довелося б потім розбирати. Порожній
     курс валідний — закрита картка на /courses лічильників не показує взагалі
     (apps/web/src/app/(app)/courses/page.tsx), тож у кадрі вона нічим не
     відрізняється від курсу зі структурою.
     ------------------------------------------------------------------------ */
  console.log('Створення курсу «ШІ для відкритих даних»…');
  ...
  /* --------------------------------------------------------------------------
     ТРЕТІЙ КУРС «Продвинутий курс» — прикладні розділи, наповнення в розробці.
     ...
     ------------------------------------------------------------------------ */
  console.log('Створення третього курсу «Продвинутий курс»…');
